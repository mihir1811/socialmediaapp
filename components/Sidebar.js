  ...
  return (
    <div className='w-full'>
        ...
        <ul className='m-0 p-0 fw500 hidden lg:block md:block sm:hidden xl:block xs:hidden duration-700 '> 
            <li className='sidebarLink p-[10px_20px] rounded-[30px] flex items-center'><AiOutlineHome className='fntSz30' />Home</li>
            <li className='sidebarLink p-[10px_20px] rounded-[30px] flex items-center'><AiOutlineSearch className='fntSz30' />Search</li>
            <li className='sidebarLink p-[10px_20px] rounded-[30px] flex items-center'><BiMoviePlay className='fntSz30' />Reels</li>
            <li className='sidebarLink p-[10px_20px] rounded-[30px] flex items-center'><RiMessengerLine className='fntSz30' />Message</li>
            <li className='sidebarLink p-[10px_20px] rounded-[30px] flex items-center'><BiBell className='fntSz30' />Notifications</li>
            </ul>
